...
export const Login = ({ info, img, src, alt, inputType }) => {
  ...
  const { data: Accounts } = useFetch(url);
  const {
    email,
    setEmail,
    password,
      ...
      <div className={styles.loginGeral}>
        <div className={styles.infosLogin}>
          ...
          <div className={styles.erro}>
            {emailErr && (
              <p className={styles.err}>Favor digite um email valido</p>
            )}
            {passwordErr && (
              <p className={styles.err}>Favor digite uma senha valido</p>
            )}
          </div>
          <button className={styles.loginButton} onClick={validate}>
            Login
          </button>
        </div>
